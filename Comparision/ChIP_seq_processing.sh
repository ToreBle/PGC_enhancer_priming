...
bwa mem "/projects/tbleckwe/data/genomes/mm10.fa"  $ID".fastq.gz" > "bwa_"$ID".sam"
...
bamCoverage --binSize 5 --normalizeUsing RPGC --effectiveGenomeSize 2150570000 --ignoreForNormalization chrX chrY -bl "/projects/tbleckwe/input/mm10.blacklist_sorted.bed" -b "bwa_"$ID"_sorted.bam" -o "bwa_"$ID".bigWig"
#bigwigCompare --bigwig1 "bwa_"$ID".bigWig" --bigwig2 "bwa_K002000134_"$input"_1.fq.gz.bigWig" --operation subtract -o "input-"$ID".bigWig"
